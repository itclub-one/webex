...
@section('content')
    ...
    <div class="card">
        <div class="card-content">
            <div class="card-body">
                <form action="{{ route('admin.pendaftaran.save') }}" method="post" enctype="multipart/form-data" class="form"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <select class="right wide mb-3" name="kelas" id="inputKelas" data-parsley-required="true">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <select class="right wide mb-3" name="jurusan" id="inputJurusan" data-parsley-required="true">
