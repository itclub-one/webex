...
@section('content')
    ...
    <div class="card">
        <div class="card-content">
            <div class="card-body">
                <form action="{{ route('admin.berita.update') }}" method="post" enctype="multipart/form-data" class="form"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="inputJudul" class="form-control" value="{{$data->judul}}"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="inputAuthor" class="form-control" value="{{$data->author}}"
                            ...
                            <div class="form-group mandatory">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-preview thumbnail mb20" data-trigger="fileinput">
                                        <img src="{{ $data->img_url ? img_src($data->img_url, 'berita') : 'http://placehold.it/500x500?text=Not Found'}}" alt="Masukan Image"
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <textarea class="summernote-simple" name="content" id="inputContent" data-parsley-required="true"
                                    placeholder="Masukan Content" autocomplete="off">{{$data->content}}</textarea>
                            </div>
                        </div>
                    </div>
