...
@section('content')
    ...
    <div class="card">
        <div class="card-content">
            <div class="card-body">
                <form action="{{ route('admin.kelas.update') }}" method="post" enctype="multipart/form-data" class="form"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="inputKodeRomawi" class="form-control" value="{{ $data->kode }}"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="inputKelas" class="form-control" value="{{ $data->kelas }}"
