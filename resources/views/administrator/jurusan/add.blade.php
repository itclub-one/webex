...
@section('content')
    @push('section_header')
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{ route('admin.jurusan') }}">Jurusan</a></div>
    ...
    <div class="card">
        <div class="card-content">
            <div class="card-body">
                <form action="{{ route('admin.jurusan.save') }}" method="post" enctype="multipart/form-data" class="form"
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="inputNama" class="form-control"
                                    placeholder="Masukan Nama Jurusan (Contoh : Akuntansi)" name="nama" autocomplete="off"
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="inputAlias" class="form-control"
                                    placeholder="Masukan Kelas Alias (Contoh : AKL)" name="alias" autocomplete="off"
                                    data-parsley-required="true">
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            async function validateRemoteNama() {
                const inputNama = $('#inputNama');
                const remoteValidationUrl = "{{ route('admin.jurusan.checkNama') }}";
