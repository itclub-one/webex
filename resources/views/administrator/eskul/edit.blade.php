...
@section('content')
    ...
    <div class="card">
        <div class="card-content">
            <div class="card-body">
                <form action="{{ route('admin.eskul.update') }}" method="post" enctype="multipart/form-data" class="form"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <select class="form-control" name="sekbid" id="inputSekbid" data-parsley-required="true">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="inputNama" class="form-control"
                                    ...
                                    value="{{ $data->nama }}" data-parsley-required="true">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="inputPembina" class="form-control"
                                    ...
                                    value="{{ $data->eskul_detail ? ($data->eskul_detail->pembina ? $data->eskul_detail->pembina : '') : '' }}"
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="inputKetua" class="form-control" placeholder="Masukan Nama Ketua"
                                    value="{{ $data->eskul_detail ? ($data->eskul_detail->ketua ? $data->eskul_detail->ketua : '') : '' }}"
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="inputWakilKetua" class="form-control"
                                    ...
                                    value="{{ $data->eskul_detail ? ($data->eskul_detail->wakil_ketua ? $data->eskul_detail->wakil_ketua : '') : '' }}"
                                    data-parsley-required="true">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <textarea class="summernote-simple" name="visi" id="inputVisi" placeholder="Masukan Visi Ekstrakurikuler"
                                    data-parsley-required="true" autocomplete="off">{{ $data->eskul_detail ? ($data->eskul_detail->visi ? $data->eskul_detail->visi : '') : '' }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <textarea class="summernote-simple" name="misi" id="inputMisi" placeholder="Masukan Misi Ekstrakurikuler"
                                    data-parsley-required="true" autocomplete="off">{{ $data->eskul_detail ? ($data->eskul_detail->misi ? $data->eskul_detail->misi : '') : '' }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <textarea class="summernote-simple" name="program_kerja" id="inputProgramKerja" data-parsley-required="true"
                                    placeholder="Masukan Program Kerja Ekstrakurikuler" autocomplete="off">{{ $data->eskul_detail ? ($data->eskul_detail->program_kerja ? $data->eskul_detail->program_kerja : '') : '' }}</textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group mandatory">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-preview thumbnail mb20" data-trigger="fileinput">
                                        <img src="{{ $data->eskul_detail ? (img_src($data->eskul_detail->logo_url, 'eskul') ? img_src($data->eskul_detail->logo_url, 'eskul') : 'http://placehold.it/500x500?text=Not Found') : 'http://placehold.it/500x500?text=Not Found' }}"
                                            alt="Masukan Logo" class="rounded-circle" width="150">
                                    </div>
                                    <div class="my-3">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <input type="text" class="form-control" name="sosmed_instagram"
                                        id="inputSosmedInstagram"
                                        placeholder="Masukkan link url instagram Ekstrakurikuler" autocomplete="off"
                                        value="{{ $sosmed ? ($sosmed['instagram'] ? $sosmed['instagram'] : '') : '' }}">
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if ('{{ $data->sekbid }}') {
                        optionSekbid.val('{{ $data->sekbid->id ?? '' }}');
                    } else {
                        optionSekbid.prepend('<option value="" selected>Pilih Data</option>');
                    }
                },
                error: function() {
