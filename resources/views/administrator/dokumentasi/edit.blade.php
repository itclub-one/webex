...
@section('content')
    @push('section_header')
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{ route('admin.dokumentasi') }}">Dokumentasi</a></div>
    ...
    <div class="card">
        <div class="card-content">
            <div class="card-body">
                <form action="{{ route('admin.dokumentasi.update') }}" method="post" enctype="multipart/form-data" class="form"
                    id="form" data-parsley-validate>
                    @csrf
                    @method('POST')
                    <input type="hidden" name="id" id="input" value="{{$data->id}}">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="inputNamaKegiatan" class="form-control" value="{{$data->nama_kegiatan}}"
                                    placeholder="Masukan Nama Kegiatan" name="nama_kegiatan" autocomplete="off"
                            ...
                            <div class="form-group mandatory">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-preview thumbnail mb20" data-trigger="fileinput">
                                        <img src="{{ $data->img_url ? img_src($data->img_url, 'dokumentasi') : 'http://placehold.it/500x500?text=Not Found'}}" alt="Masukan Image"
                                            class="" width="150">
                                    </div>
                                    <div class="my-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <textarea class="summernote-simple" name="caption" id="inputCaption" data-parsley-required="true"
                                    placeholder="Masukan Caption" autocomplete="off">{{$data->caption}}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-end">
                            ...
                            <a href="{{ route('admin.dokumentasi') }}" class="btn btn-danger mx-1 mb-1">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
...
@push('js')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $.ajax({
                url: '{{ route('admin.dokumentasi.getEskul') }}',
                method: 'GET',
                success: function(response) {
                    ...
                    if ('{{ $data->eskul }}') {
                        ...
                        optionEskul.prepend('<option value="" selected>Pilih Data</option>');
                    }
