...
@section('content')
    ...
    <div class="card">
        <div class="card-content">
            <div class="card-body">
                <form action="{{ route('admin.dokumentasi.save') }}" method="post" enctype="multipart/form-data" class="form"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="inputNamaKegiatan" class="form-control"
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <textarea class="summernote-simple" name="caption" id="inputCaption" data-parsley-required="true"
                                    placeholder="Masukan Caption" autocomplete="off"></textarea>
                            </div>
                        </div>
                    </div>
