            ...
            <div class="row">
                <div class="col-auto">
                    <div class="breadcrumbs__content">
                        ...
                        <div class="breadcrumbs__item ">
                            <a style="pointer-events: none; cursor: default;">Tentang Web</a>
                        </div>
                ...
                <div class="row justify-center text-center">
                    <div class="col-auto">
                        <div data-anim="slide-up delay-1">
                            ...
                            <h1 class="page-header__title">Tentang Web</h1>
        ...
        <div data-anim-wrap class="container">
            <div class="row y-gap-50 justify-between items-center">
                ...
                <div class="col-lg-6 pr-50 sm:pr-15">
                    <div class="composition -type-8">
                        <div class="-el-1"><img style="width: 400px; height: 400px;"
                                src="{{ asset('images/tentang-web/pak-andri.png') }}" alt="image"></div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    ...
                    <p class="text-dark-1 mt-30">Alhamdulillah Sistem Informasi Ekstrakurikuler SMKN 1 Garut Berbasis
                        Website yang diberi nama Webex (Web Ekskul) dapat digunakan oleh seluruh ekstrakurikuler SMKN 1
            ...
            <div class="row y-gap-50 justify-between items-center">
                ...
                <div class="col-lg-12">
                    ...
                    <p class="text-dark-1 mt-30">Saya mengucapkan Terima Kasih Kepada Bapak Kepala Sekolah yaitu Bapak H.
                        Bejo Siswoyo, S.Tp., M.Pd. yang selalu mendukung dan memberikan semangat kepada kami,
                        serta Bapak Wakil Kepala Sekolah Bidang Kesiswaan yaitu Bapak Nurdin, S.T., M.Pd. yang telah
                        mendukung sistem informasi ekstrakurikuler SMKN 1 Garut, Bapak Staf Wakil Kepala Sekolah
                        Bidang Kesiswaan Bapak Iwan Ridwan, S.Sy., M.Pd. Serta Ibu Pembina OSIS SMKN 1 Garut Ibu Citra
                        Purnamasari, S.Pd. yang telah mendukung kami,
                        serta saya mengucapkan Terima Kasih kepada Bapak Ketua Kompetensi Keahlian Sistem Informatika
                        Jaringan dan Aplikasi serta Pengembangan Perangkat Lunak dan Gim Bapak Asep Ulumudin, S.Kom. yang
                        telah memberikan fasilitas hosting dan domain
                        sehingga website ini dapat diakses oleh kami. Saya juga mengucapkan Terima kasih kepada Bapak dan
                        Ibu Pembina Ekstrakurikuler yang telah
                        memberikan dukungan kepada kami dan dari kami saya ucapkan selamat menggunakan sistem informasi
                        ekstrakurikuler ini untuk ekstrakurikuler masing masing
                        semoga dapat membantu dalam manajemen ekstrakurikuler yang bapak dan ibu bimbing.</p>
                    <p class="text-dark-1 mt-30">Sekian dari saya selaku pembina ekstrakurikuler IT Club dan besar harapan
                        saya agar Webex ini dapat digunakan dan dapat membantu
        ...
        <div data-anim-wrap class="container">
            ...
            <div class="row y-gap-30 pt-50">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="teamCard -type-1 -teamCard-hover">
                        <div class="teamCard__image">
                            <img style="width: 300px; height: 350px;" src="{{ asset('images/tentang-web/yusuf.png') }}"
                                alt="image">
                            <div class="teamCard__socials">
                                <div class="d-flex x-gap-20 y-gap-10 justify-center items-center h-100">
                                    <a href="#"><i class="icon-facebook text-white"></i></a>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="teamCard -type-1 -teamCard-hover">
                        <div class="teamCard__image">
                            <img style="width: 300px; height: 350px;" src="{{ asset('images/tentang-web/ilham.png') }}"
                                alt="image">
                            <div class="teamCard__socials">
                                <div class="d-flex x-gap-20 y-gap-10 justify-center items-center h-100">
                                    <a href="#"><i class="icon-facebook text-white"></i></a>
